...
echo 95000000 | sudo tee /sys/class/powercap/intel-rapl/intel-rapl:0/constraint_2_power_limit_uw
echo 15000000 | sudo tee /sys/class/powercap/intel-rapl-mmio:0/constraint_0_power_limit_uw
echo 45000000 | sudo tee /sys/class/powercap/intel-rapl-mmio:0/constraint_1_power_limit_uw
...
#AHCI
echo enabled | sudo tee /sys/class/net/wlp0s20f3/device/power/wakeup
echo enabled | sudo tee /sys/bus/usb/devices/usb3/power/wakeup
echo enabled | sudo tee /sys/bus/usb/devices/usb1/power/wakeup
echo enabled | sudo tee /sys/bus/usb/devices/3-2/power/wakeup
echo enabled | sudo tee /sys/bus/usb/devices/3-9/power/wakeup
echo enabled | sudo tee /sys/bus/usb/devices/usb4/power/wakeup
echo enabled | sudo tee /sys/bus/usb/devices/3-10/power/wakeup
